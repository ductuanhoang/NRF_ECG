...
static void QRS_process_buffer(volatile uint8_t *Heart_rate);
static void QRS_check_sample_crossing_threshold(uint16_t scaled_result, volatile uint8_t *Heart_rate);
